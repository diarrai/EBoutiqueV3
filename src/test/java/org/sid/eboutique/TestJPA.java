...
public class TestJPA {
	...
	public void test1() {
		try {
			 ...
			 metier.ajouterCategorie(new Categorie("Ordinateurs", "Orditerrrrrr", null, "image1.jpg"));
			 metier.ajouterCategorie(new Categorie("Imprimantes", "Imprmmmmmm", null, "image1.jpg"));
	...
	public void test2() {
		try {
			...
			assertTrue(prods.size()+2==prods1.size());
		} catch (Exception e) {
			assertTrue(e.getMessage(),false);
		}
